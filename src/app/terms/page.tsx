...
const sections = [
  ...
  { title: "Limitation of liability", body: "DropEra is not liable for indirect, incidental, or consequential damages arising from use of this site or its products, to the extent permitted by law." },
